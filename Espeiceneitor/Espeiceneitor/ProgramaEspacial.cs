    ...
    public class ProgramaEspacial
    {
        ...
        private static void CadastroMissao()
        {
            ...
            do
            {
                ...
                {
                    throw new Exception($"Ocorreu um erro na rotina de cadastro de missões. Mensagem: {erro.Message}");
                    ConsoleUtil.AguardarTecla();
                }
        ...
        private static Missao BuscarMissao(int index)
        {
            ...
            {
                throw new Exception($"Ocorreu um erro na rotina de buscar missões. Mensagem: {erro.Message}");
                ConsoleUtil.AguardarTecla();
            }
        }
